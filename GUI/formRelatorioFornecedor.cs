...
using static DAL.DALRelatorioFornecedor;
using Document = iTextSharp.text.Document;

namespace UI
{
    public partial class formRelatorioFornecedor : Form
    {
        string connectionString = DadosDaConexao.StringDeConexao;
        private DALConexao conexao;

        DALRelatorioFornecedor dalRelatorioFornecedor;
        public formRelatorioFornecedor()
        {
            InitializeComponent();
        }

        private void formRelatorioFornecedor_Load(object sender, EventArgs e)
        {
            this.menuBotoes(1);
        }
        ...
        private void btnGerarRelatorio_Click_1(object sender, EventArgs e)
        {
            ...
            this.dalRelatorioFornecedor = new DALRelatorioFornecedor(conexao);

            List<FornecedorRelatorio> dadosRelatorio = dalRelatorioFornecedor.ObterLinhasFornecedor(nomeTabela);
        ...
        private void btnExportarRelatorio_Click(object sender, EventArgs e)
        {
            ...
            saveDialog.FileName = "RelatorioFornecedor.pdf";
